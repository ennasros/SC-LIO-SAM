...
public:
    mapOptimization()
    {
        ...
        downSizeFilterSC.setLeafSize(scancontextLeafSize, scancontextLeafSize, scancontextLeafSize); // giseop
    ...
    bool saveMapService(lio_sam::save_mapRequest& req, lio_sam::save_mapResponse& res)
    {
      ...
      if(req.resolution != 0)
      {
        ...
        downSizeFilterCorner.filter(*globalCornerCloudDS);
        pcl::io::savePCDFileBinary(saveMapDirectory + "cloudCorner.pcd", *globalCornerCloudDS);
        // down-sample and save surf cloud
        downSizeFilterSurf.setInputCloud(globalSurfCloud);
        downSizeFilterSurf.setLeafSize(req.resolution, req.resolution, req.resolution);
        downSizeFilterSurf.filter(*globalSurfCloudDS);
        pcl::io::savePCDFileBinary(saveMapDirectory + "cloudSurf.pcd", *globalSurfCloudDS);
      }
      else
      {
        // save corner cloud
        pcl::io::savePCDFileBinary(saveMapDirectory + "cloudCorner.pcd", *globalCornerCloud);
        // save surf cloud
        pcl::io::savePCDFileBinary(saveMapDirectory + "cloudSurf.pcd", *globalSurfCloud);
      }
      ...
      *globalMapCloud += *globalSurfCloud;
      ...
      int ret = pcl::io::savePCDFileBinary(saveMapDirectory + "cloudGlobal.pcd", *globalMapCloud);
      res.success = ret == 0;
